...
namespace CollectionsMasterConsoleUI
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("First and last number in a random number array:");
            ...
            */
            ...
            Console.WriteLine("Initial List capacity:");
            ...
            do
            {
                ...
                number = int.TryParse(Console.ReadLine(), out userNumber);
            }
            while (!number);
            ...
            var myArray = intList.ToArray();

            //TODO: Clear the list
            intList.Clear();

            Console.WriteLine("Whew, that was a lot. (^-^\')");
            #endregion
        }
        ...
        private static void NumberChecker(List<int> numberList, int searchNumber)
        {
             ...
             {
                 Console.WriteLine($"Yes, your number is in the list.");
             }
             else
             {
                 Console.WriteLine($"I have no memory of this number.");
             }
